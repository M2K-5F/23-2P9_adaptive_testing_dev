...
@topic_router.get('/{user_group_id}/get_followed', summary='Get user topics by followed course')
async def get_followed_teacher_topics(
    ...
    return topic_service.get_user_topics_by_user_group(current_user, user_group_id)


@topic_router.get("/{course_id}/get", summary='Get topics by any course')
...
@topic_router.post('/{topic_id}/start', summary='Start passing the topic at followed course')
